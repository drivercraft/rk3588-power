...
static RKVDEC_QOS_OFFSETS: &[usize] = &[
    QOS_RKVDEC_BASE,
    QOS_RKVDEC_BASE + 0x1000,
];

static RKVENC_QOS_OFFSETS: &[usize] = &[
    QOS_RKVENC_BASE,
    QOS_RKVENC_BASE + 0x1000,
];
